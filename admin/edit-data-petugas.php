    ...
    <div class="card shadow">
        ...
        <div class="card-body">
          ...
          $_SESSION['alert'] = FALSE;
            ...
            <form method="POST" action="../function/admin/edit-data-petugas.php">
            ...
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" disabled id="nama" value="<?= $data['nama'] ?>" name="nama" required>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" disabled id="username" value="<?= $data['username'] ?>" name="username" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" disabled id="username" value="<?= ($data['level'] == '1') ? 'Admin' : 'Petugas' ?>" name="username" required>
                    </div>
